...
@SuppressWarnings("unused") public class AvatarImageBehavior
    ...
    public AvatarImageBehavior(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            mCustomFinalYPosition =
                a.getDimension(R.styleable.AvatarImageBehavior_finalYPosition, 0);
            mCustomStartXPosition =
                a.getDimension(R.styleable.AvatarImageBehavior_startXPosition, 0);
    ...
    private void maybeInitProperties(ImageView child, View dependency) {
        ...
        if (mChangeBehaviorPoint == 0) {
            mChangeBehaviorPoint = (child.getHeight() - mCustomFinalHeight) / (2f * (mStartYPosition
                - mFinalYPosition));
        }
    }
